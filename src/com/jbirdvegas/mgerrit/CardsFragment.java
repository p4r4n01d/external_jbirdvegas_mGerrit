...
public abstract class CardsFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        mWebsite = new StringBuilder(0)
                .append(Prefs.getCurrentGerrit(mParent.getApplicationContext()))
    ...
    private void setup()
    {
        ...
        /* TODO: We cannot use intents as we are now using fragments instead of activities.
         *  Here, we will get the MAIN intent. */
